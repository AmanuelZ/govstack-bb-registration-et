  ...
  fastify.get(
    '/tasks',
    {
      schema: {
        ...
        description:
          'Returns tasks filtered by role, application, or status. Operators should filter by their role.',
        querystring: {
          type: 'object',
          properties: {
  ...
  fastify.get(
    '/tasks/:taskId',
    {
      schema: {
        ...
        description:
          'Returns task details with pre-filled form variables and the full application context.',
        params: {
          type: 'object',
  ...
  fastify.post(
    '/tasks/:taskId/complete',
    {
      schema: {
        ...
        description:
          'Complete a task with APPROVE, REJECT, SEND_BACK, or REQUEST_INFO. Drives workflow state transitions.',
        params: {
          type: 'object',
          properties: { taskId: { type: 'string', format: 'uuid' } },
          required: ['taskId'],
